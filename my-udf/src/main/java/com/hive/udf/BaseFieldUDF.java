...
public class BaseFieldUDF extends UDF {
    ...
    public String evaluate(String line, String key1, String key2){
        if(line == null){
            return "";
        }
        ...
        try {
            ...
            else if(key1.equals("cm")){
                JSONObject object = new JSONObject(lines[1]);
                JSONObject cmObject = object.getJSONObject(key1);
                value = cmObject.getString(key2);
            }
            else if(key1.equals("et") && key2.equals("")){
                JSONObject object = new JSONObject(lines[1]);
                value = object.getString(key1);
            }
    ...
    public static void main(String[] args) {
        ...
        String x = new BaseFieldUDF().evaluate(line, "cm", "mid");
        System.out.println(x);
        String y = new BaseFieldUDF().evaluate(line, "et", "");
        System.out.println(y);
        String z = new BaseFieldUDF().evaluate(line, "", "");
